...
const cruiseData = [
  ...
  },
  {
    ...
    transferInfo: 'Ship docks in Salerno. Quick taxi to Salerno Centrale Station. Take Trenitalia regional train to Pompei station (approx. 40 mins). Walk 15 mins to Pompeii Scavi Piazza Anfiteatro entrance. Return early to ensure stress-free embarkation.',
    tags: ['Pompeii', 'Roman Ruins', 'Trenitalia', 'History'],
    deepDive: {
      logisticsTitle: "DIY Master Execution Strategy",
      logisticsMode: "Trenitalia Train & Walk",
      badgeClass: "badge-success",
      estCost: "€3/pax Train + €18/pax Pompeii Entry",
      logisticsSummary: "Disembark by 08:30 AM. Take a quick taxi to Salerno Centrale. Buy round-trip regional train tickets to 'Pompei' at the kiosk (~€3 each way). Train takes 35-45 minutes. From Pompei station, walk 15 mins to the Piazza Anfiteatro entrance. Book entry tickets online on the official site. Take a 1:00 PM or 2:00 PM train back to Salerno to be back comfortably early and avoid any anxiety.",
      timedItinerary: [
        "07:00 AM — Ship docks in Salerno (Molo Manfredi).",
        "08:30 AM — Disembark ship nice and early. Grab a 5-minute taxi to Salerno Centrale train station.",
        ...
        "01:30 PM — Board return Trenitalia train from Pompei station back to Salerno Centrale.",
        "02:15 PM — Arrive in Salerno and grab a taxi back to the cruise port.",
        "02:30 PM — Comfortably back on board Norwegian Viva with zero stress!",
        "05:15 PM — All-Aboard onboard Viva (Ship sails 6:00 PM)."
      ],
      diningSpots: [
