...
const cruiseData = [
  ...
  },
  {
    ...
    transferInfo: 'Grab a quick taxi right at the port to Salerno Centrale (~€10 flat rate). Take Trenitalia regional train to Pompei (approx 40 mins). Walk 15 mins to Pompeii Scavi Piazza Anfiteatro. On return, grab a taxi outside Salerno station back to port.',
    tags: ['Pompeii', 'Roman Ruins', 'Trenitalia', 'History'],
    deepDive: {
      logisticsTitle: "DIY Master Execution Strategy",
      logisticsMode: "Trenitalia Train & Taxi",
      badgeClass: "badge-success",
      estCost: "€3/pax Train + €10 Taxi + €18/pax Pompeii Entry",
      logisticsSummary: "Disembark by 08:30 AM. Grab a taxi at the cruise terminal directly to Salerno Centrale station (~€10 flat rate). Buy round-trip regional train tickets to 'Pompei' (~€3 each way). From Pompei station, walk 15 mins to the Piazza Anfiteatro entrance.<br><br><b>Train Return Options (Getting back before 16:30):</b><br>• 13:30 (Arr Salerno 14:15)<br>• 14:05 (Arr Salerno 14:45)<br>• 14:45 (Arr Salerno 15:25)<br>• 15:30 (Arr Salerno 16:15)",
      timedItinerary: [
        "07:00 AM — Ship docks in Salerno (Molo Manfredi).",
        "08:30 AM — Disembark ship. Grab a quick taxi to Salerno Centrale (~€10).",
        ...
        "02:30 PM — Arrive in Salerno and grab a taxi back to the cruise port (~€10).",
        "05:15 PM — All-Aboard onboard Viva (Ship sails 6:00 PM)."
      ],
      diningSpots: [
