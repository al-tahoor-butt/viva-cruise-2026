...
const cruiseData = [
  ...
  },
  {
    ...
    highlight: 'Ancient Ruins of Pompeii & Mount Vesuvius Backdrop',
    adultsActivities: 'Explore the incredibly preserved Roman city of Pompeii frozen in time by the 79 AD eruption.',
    kidsActivities: 'Walk through ancient gladiator arenas, amphitheatres, and authentic Roman streets.',
    transferInfo: 'Walk 5 mins out of port to the Via Ligea bus stop and take a local CSTP bus (or grab a taxi) to Salerno Centrale. Take Trenitalia regional train to Pompei (approx 40 mins). Walk 15 mins to Pompeii Scavi Piazza Anfiteatro.',
    tags: ['Pompeii', 'Roman Ruins', 'Trenitalia', 'History'],
    deepDive: {
      logisticsTitle: "DIY Master Execution Strategy",
      logisticsMode: "Trenitalia Train & Local Bus",
      badgeClass: "badge-success",
      estCost: "€3/pax Train + €18/pax Pompeii Entry",
      logisticsSummary: "Disembark by 08:30 AM. Walk out of the port gates to the main road (Via Ligea) and take a local bus (or a quick taxi) to Salerno Centrale station. Buy round-trip regional train tickets to 'Pompei' (~€3 each way). From Pompei station, walk 15 mins to the Piazza Anfiteatro entrance.<br><br><b>Train Return Options (Getting back before 16:30):</b><br>• 13:30 (Arr Salerno 14:15)<br>• 14:05 (Arr Salerno 14:45)<br>• 14:45 (Arr Salerno 15:25)<br>• 15:30 (Arr Salerno 16:15)",
      timedItinerary: [
        "07:00 AM — Ship docks in Salerno (Molo Manfredi).",
        "08:30 AM — Disembark ship. Walk out to Via Ligea and take a local bus or taxi to Salerno Centrale.",
        "09:00 AM — Board Trenitalia Regional train to Pompei station (not the Circumvesuviana line).",
        "09:40 AM — Arrive at Pompei station. Walk 15 mins to the Pompeii ruins entrance (Piazza Anfiteatro).",
        "10:00 AM — Explore the ancient ruins of Pompeii (Forum, Amphitheatre, Lupanar).",
        "12:30 PM — Quick pizza or panini for lunch in modern Pompei town.",
        "01:30 PM — Head back to Pompei train station.",
        "01:45 PM — Board one of the afternoon Trenitalia return trains back to Salerno.",
        "02:30 PM — Arrive in Salerno and take the local bus or taxi back to the cruise port.",
        "05:15 PM — All-Aboard onboard Viva (Ship sails 6:00 PM)."
      ],
      diningSpots: [
        { name: "Mercato Pompeiano (Via Sacra)", type: "Lunch", note: "Great local spot for authentic Neapolitan pizza just outside the ruins." },
        { name: "Gelateria De Vivo", type: "Dessert", note: "Famous artisanal gelato in the center of Pompei town." }
      ]
    }
  },
  {
